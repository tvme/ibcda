...
'''
https://www.kaggle.com/rmealey/liberty-mutual-group-property-inspection-prediction/calculating-normalized-gini-coefficient
port the R version over directly
'''
...
if __name__ == '__main__':                                                      
    import pandas as pd
    # test case 1
    desired_y = np.array(pd.read_csv("C:\Users\User\PycharmProjects\ibcda\data\\train_for_gini_coef.csv")["Hazard"])
